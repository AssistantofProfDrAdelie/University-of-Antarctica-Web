...
class AppServerTest(unittest.TestCase):
    ...
    def test_ui_contains_complete_encounter_loop(self):
        ...
        self.assertIn("hits.sh/assistantofprofdradelie.github.io/University-of-Antarctica-Web/experiences/encounter-penguin.svg", markup)
        self.assertIn("referrerpolicy=\"no-referrer\"", markup)
